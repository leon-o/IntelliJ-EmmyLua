...
public class LuaDocParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // class_name_ref(COMMA class_name_ref)*{
  // }
  public static boolean class_name_ref_list(PsiBuilder b, int l) {
    ...
    r = r && class_name_ref_list_2(b, l + 1);
    exit_section_(b, m, CLASS_NAME_REF_LIST, r);
    return r;
  }

  // (COMMA class_name_ref)*
  ...
  // {
  // }
  private static boolean class_name_ref_list_2(PsiBuilder b, int l) {
    return true;
  }
  ...
  /* ********************************************************** */
  // (TAG_NAME_CLASS|TAG_NAME_MODULE) ID (EXTENDS class_name_ref_list)? comment_string?
